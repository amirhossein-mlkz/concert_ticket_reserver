...
"}")
        ...
        self.start_chair = QSpinBox(self.page)
        ...
        self.end_chair = QSpinBox(self.page)
        ...
        self.start_chair_checkbox = QCheckBox(self.page)
        ...
        self.end_chair_checkbox = QCheckBox(self.page)
